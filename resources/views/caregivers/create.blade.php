        ...
        <form method="POST" action="{{ route('caregivers.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-5">
                    ...
                    <input type="text" name="relationship_to_student" class="form-control" value="{{ old('relationship_to_student') }}" placeholder="e.g. Father, Mother, Aunt">
                </div>
                ...
                <div class="col-12 mt-4">
                    <button type="submit" class="btn btn-primary px-4">
                        <i class="bi bi-check-circle me-1"></i> Save Caregiver
                    </button>
